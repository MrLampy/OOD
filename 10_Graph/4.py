...
def find_shortest_route(start_station, end_station, graph):
    if start_station == end_station:
        return [start_station]

    if start_station not in graph or end_station not in graph:
        return ["Error: One or both stations not found in the graph data."]
...
def solve_route_problem(input_string, graph_data):
    start_station, end_station = [s.strip() for s in input_string.split(',')]
    print(f"From: {start_station}")
    print(f"To: {end_station}")
    print("Searching shortest route... This may take a while...")

    route = find_shortest_route(start_station, end_station, graph_data)
    print("Suggested Route: ")
    print(route)

input = input('Enter : ')
solve_route_problem(input, tubemap)